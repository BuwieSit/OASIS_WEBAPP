...
export function ProgressModal({ progress = 0, visible, onCancel, title = "Processing..." }) {
    ...
    return (
        <div className="fixed inset-0 z-500 bg-black/60 backdrop-blur-md flex items-center justify-center p-4 animate__animated animate__fadeIn">
            <div className="bg-white w-full max-w-sm rounded-[2rem] shadow-2xl overflow-hidden flex flex-col p-8 items-center text-center relative animate__animated animate__zoomIn animate__faster">
