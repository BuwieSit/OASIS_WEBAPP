...
export default function Notifications({ 
    ...
    return (
        ...
        >
            ...
            <div className="mt-3 h-[85%] flex flex-col justify-start items-start overflow-y-auto overflow-x-auto pr-2">
                {loading ? (
                    ...
                    filteredNotifications.map((item) => (
                        <div
                            ...
                            className={`w-full p-3 rounded-2xl overflow-auto bg-red-500 flex flex-col gap-3 mt-3 shadow-[0px_0px_5px_rgba(0,0,0,0.5)] mb-3 cursor-pointer transition-all ${
